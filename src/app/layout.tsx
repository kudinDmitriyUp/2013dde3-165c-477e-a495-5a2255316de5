...
export const metadata: Metadata = {
  title: "VC TechShop Milano - Venture Capital Investment",
  description: "Leading European venture capital firm investing in disruptive tech startups. Portfolio includes AI, fintech, deeptech, and climate solutions.",
  keywords: "venture capital, tech investment, startup funding, Milan, Europe, innovation, AI, fintech",
  robots: {
    index: true,
    follow: true
  },
  openGraph: {
    title: "VC TechShop Milano - Invest in Innovation",
    description: "Join founders transforming technology and industry. Access capital, mentorship, and strategic connections.",
    type: "website",
    siteName: "VC TechShop Milano",
    images: [
      {
        url: "https://webuild-dev.s3.eu-north-1.amazonaws.com/users/user_32SgGlSmvaVv2SYOkECykbr8Q49/uploaded-1764144423127-u32sb4ti.jpg",
        alt: "VC TechShop Milano - Venture Capital Investment"
      }
    ]
  },
  twitter: {
    card: "summary_large_image",
    title: "VC TechShop Milano - Venture Capital",
    description: "Leading European VC backing visionary founders in AI, fintech, and climate tech.",
    images: ["https://webuild-dev.s3.eu-north-1.amazonaws.com/users/user_32SgGlSmvaVv2SYOkECykbr8Q49/uploaded-1764144423127-u32sb4ti.jpg"]
  }
};
